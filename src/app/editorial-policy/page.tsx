  ...
  return (
    <>
      ...
      <section className="section utility-section"><div className="shell utility-layout"><article className="prose utility-prose">
        ...
        <p>We begin with the bather experience and the decision a reader must make, identify the facts that change it, and link the most authoritative current sources. We also state our judgment. Traditional löyly is our reference experience; ceiling, bench, foot, and stone relationships set the hot zone; ventilation must serve people and drying; electric is the default for most home routines; thermally modified wood earns a preference where stability matters; and every product recommendation must include the problem it solves and the tradeoff it creates.</p>
        ...
        <h2>How we handle disagreement and constraints</h2>
        <p>We cross-check design claims against current manuals, official manufacturer guidance, certification context, code-linked safety requirements, and credible health evidence. We publish the resulting rule in our own voice, not a personality contest. When guidance depends on mechanical versus gravity ventilation, a specific sensor, an existing room, accessibility, or local code, we name the dependency and show the safest practical compromise.</p>
