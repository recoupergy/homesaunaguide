...
export default function ContactPage() {
  return (
    <>
      <header className="page-hero"><div className="shell narrow-hero"><Breadcrumbs items={[{ name: "Home", href: "/" }, { name: "Contact" }]} /><span className="kicker light">Send the useful detail</span><h1>Contact Home Sauna Guide.</h1><p>Corrections, primary sources, archive questions, and serious editorial inquiries are welcome.</p></div></header>
      <section className="section utility-section"><div className="shell contact-grid">
        ...
        <div className="contact-aside"><h2>We can help with</h2><ul><li>Factual corrections and broken links</li><li>Primary manuals or certification updates</li><li>Archive provenance and URL continuity</li><li>Editorial and licensing inquiries</li></ul><p>We cannot approve a specific installation, diagnose symptoms, or replace a licensed contractor, authority having jurisdiction, or clinician.</p></div>
      </div></section>
    </>
  );
}
