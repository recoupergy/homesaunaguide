...
export default function SourcesPage() {
  return (
    <>
      <header className="page-hero"><div className="shell narrow-hero"><Breadcrumbs items={[{ name: "Home", href: "/" }, { name: "Sources" }]} /><span className="kicker light">Go to the authority</span><h1>Primary-source library.</h1><p>Reliable sauna decisions begin with the exact manual, current listing, local requirements, and evidence appropriate to the claim.</p></div></header>
